...
export function montarRelatorio({ analysisId, result, createdAt }) {
  ...
  return {
    ...
    home: {
      ...
      distancia_divergencia_cadastral: home.distancia_divergencia_cadastral ?? null,
      instrumento: home.instrumento || null,
      instrumento_geo: home.instrumento_geo || null,
      endereco_nao_informado: home.endereco_nao_informado || false,
      endereco_literal: home.endereco_literal || null,
    },
